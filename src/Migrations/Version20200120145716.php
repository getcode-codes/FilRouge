 ...
 */
final class Version20200120145716 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compte DROP parteners_id, DROP user_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compte ADD parteners_id INT NOT NULL, ADD user_id INT NOT NULL');
